...
export function generateInitialSettings(): SettingsData {
  return {
    ...
    translate_titles_enabled: settingsDefaults.translate_titles_enabled,
...
export function parseSettingsData(data: Record<string, string>): SettingsData {
  return {
    ...
    ai_translation_profile_id: data.ai_translation_profile_id || settingsDefaults.ai_translation_profile_id,
    ...
    custom_translation_body_template: data.custom_translation_body_template || settingsDefaults.custom_translation_body_template,
    custom_translation_enabled: data.custom_translation_enabled === 'true',
    custom_translation_endpoint: data.custom_translation_endpoint || settingsDefaults.custom_translation_endpoint,
    custom_translation_headers: data.custom_translation_headers || settingsDefaults.custom_translation_headers,
    custom_translation_lang_mapping: data.custom_translation_lang_mapping || settingsDefaults.custom_translation_lang_mapping,
    custom_translation_method: data.custom_translation_method || settingsDefaults.custom_translation_method,
    custom_translation_name: data.custom_translation_name || settingsDefaults.custom_translation_name,
    custom_translation_response_path: data.custom_translation_response_path || settingsDefaults.custom_translation_response_path,
    custom_translation_timeout: parseInt(data.custom_translation_timeout) || settingsDefaults.custom_translation_timeout,
    ...
    freshrss_auto_sync_interval: parseInt(data.freshrss_auto_sync_interval) || settingsDefaults.freshrss_auto_sync_interval,
    freshrss_enabled: data.freshrss_enabled === 'true',
    freshrss_last_sync_time: data.freshrss_last_sync_time || settingsDefaults.freshrss_last_sync_time,
    ...
    retry_timeout_seconds: parseInt(data.retry_timeout_seconds) || settingsDefaults.retry_timeout_seconds,
    ...
    translate_titles_enabled: data.translate_titles_enabled === 'true',
...
export function buildAutoSavePayload(settingsRef: Ref<SettingsData>): Record<string, string> {
  return {
    ...
    ai_search_enabled: (settingsRef.value.ai_search_enabled ?? settingsDefaults.ai_search_enabled).toString(),
    ai_search_profile_id: settingsRef.value.ai_search_profile_id ?? settingsDefaults.ai_search_profile_id,
    ai_summary_profile_id: settingsRef.value.ai_summary_profile_id ?? settingsDefaults.ai_summary_profile_id,
    ai_summary_prompt: settingsRef.value.ai_summary_prompt ?? settingsDefaults.ai_summary_prompt,
    ai_translation_profile_id: settingsRef.value.ai_translation_profile_id ?? settingsDefaults.ai_translation_profile_id,
    ...
    content_font_family: settingsRef.value.content_font_family ?? settingsDefaults.content_font_family,
    content_font_size: (settingsRef.value.content_font_size ?? settingsDefaults.content_font_size).toString(),
    content_line_height: settingsRef.value.content_line_height ?? settingsDefaults.content_line_height,
    custom_css_file: settingsRef.value.custom_css_file ?? settingsDefaults.custom_css_file,
    custom_translation_body_template: settingsRef.value.custom_translation_body_template ?? settingsDefaults.custom_translation_body_template,
    custom_translation_enabled: (settingsRef.value.custom_translation_enabled ?? settingsDefaults.custom_translation_enabled).toString(),
    custom_translation_endpoint: settingsRef.value.custom_translation_endpoint ?? settingsDefaults.custom_translation_endpoint,
    custom_translation_headers: settingsRef.value.custom_translation_headers ?? settingsDefaults.custom_translation_headers,
    custom_translation_lang_mapping: settingsRef.value.custom_translation_lang_mapping ?? settingsDefaults.custom_translation_lang_mapping,
    custom_translation_method: settingsRef.value.custom_translation_method ?? settingsDefaults.custom_translation_method,
    custom_translation_name: settingsRef.value.custom_translation_name ?? settingsDefaults.custom_translation_name,
    custom_translation_response_path: settingsRef.value.custom_translation_response_path ?? settingsDefaults.custom_translation_response_path,
    custom_translation_timeout: (settingsRef.value.custom_translation_timeout ?? settingsDefaults.custom_translation_timeout).toString(),
    ...
    freshrss_auto_sync_interval: (settingsRef.value.freshrss_auto_sync_interval ?? settingsDefaults.freshrss_auto_sync_interval).toString(),
    freshrss_enabled: (settingsRef.value.freshrss_enabled ?? settingsDefaults.freshrss_enabled).toString(),
    freshrss_last_sync_time: settingsRef.value.freshrss_last_sync_time ?? settingsDefaults.freshrss_last_sync_time,
    freshrss_server_url: settingsRef.value.freshrss_server_url ?? settingsDefaults.freshrss_server_url,
    freshrss_sync_on_startup: (settingsRef.value.freshrss_sync_on_startup ?? settingsDefaults.freshrss_sync_on_startup).toString(),
    ...
    notion_enabled: (settingsRef.value.notion_enabled ?? settingsDefaults.notion_enabled).toString(),
    ...
    retry_timeout_seconds: (settingsRef.value.retry_timeout_seconds ?? settingsDefaults.retry_timeout_seconds).toString(),
    rsshub_api_key: settingsRef.value.rsshub_api_key ?? settingsDefaults.rsshub_api_key,
    rsshub_enabled: (settingsRef.value.rsshub_enabled ?? settingsDefaults.rsshub_enabled).toString(),
    ...
    show_floating_toc: (settingsRef.value.show_floating_toc ?? settingsDefaults.show_floating_toc).toString(),
    ...
    translate_titles_enabled: (settingsRef.value.translate_titles_enabled ?? settingsDefaults.translate_titles_enabled).toString(),
    translation_enabled: (settingsRef.value.translation_enabled ?? settingsDefaults.translation_enabled).toString(),
    translation_only_mode: (settingsRef.value.translation_only_mode ?? settingsDefaults.translation_only_mode).toString(),
    ...
    zotero_enabled: (settingsRef.value.zotero_enabled ?? settingsDefaults.zotero_enabled).toString(),
