...
const en: TranslationMessages = {
  article: {
    ...
    translation: {
      alreadyTargetLanguage:
        'This article already appears to be in the target language. Translation was skipped.',
      aiLimitReached: 'AI usage limit reached. Using free alternatives.',
      batchTranslateTitles: 'Translate current list titles',
      batchTranslateTitlesConfirmMessage:
        'Translate {count} untranslated titles in the current list order and save them to the title cache?',
      batchTranslateTitlesDone: 'Translated {count} titles',
      batchTranslateTitlesFailed: 'Failed to batch translate titles: {message}',
      batchTranslateTitlesStopped: 'Stopped title translation after {count} titles',
      contentTranslated: 'Article translation completed',
      modeBilingual: 'Bilingual',
      modeBilingualDesc: 'Show translation first, then original text',
      modeOriginal: 'Original',
      modeOriginalDesc: 'Show the article without translation',
      modeTranslated: 'Translated only',
      modeTranslatedDesc: 'Show only translated text',
      noTitlesToTranslate: 'There are no untranslated titles in the current list',
      stopBatchTranslateTitles: 'Stop title translation',
      translateButton: 'Translate article',
      translateButtonWithMode: 'Translate: {mode}',
    },
    videoPlayer: {
  ...
  setting: {
    ...
    content: {
      ...
      enableTranslationDesc: 'Enable the reader translation button and translation settings',
      ...
      targetLanguageDesc: 'Language to translate article content and titles to',
      translateTitles: 'Translate Article Titles',
      translateTitlesDesc:
        'Translate the current article title when you switch this article into translation mode',
