...
const zh: TranslationMessages = {
  article: {
    ...
    translation: {
      alreadyTargetLanguage: '这篇文章看起来已经是目标语言，已跳过翻译。',
      aiLimitReached: 'AI 使用量已达上限，正在使用免费替代方案。',
      batchTranslateTitles: '翻译当前列表标题',
      batchTranslateTitlesConfirmMessage:
        '将按当前列表顺序翻译 {count} 个尚未翻译的标题，并写入标题缓存。是否继续？',
      batchTranslateTitlesDone: '已翻译 {count} 个标题',
      batchTranslateTitlesFailed: '标题批量翻译失败：{message}',
      batchTranslateTitlesStopped: '已停止标题翻译，已完成 {count} 个标题',
      contentTranslated: '文章翻译完成',
      modeBilingual: '双语对照',
      modeBilingualDesc: '上方显示译文，下方显示原文',
      modeOriginal: '原文',
      modeOriginalDesc: '不显示翻译',
      modeTranslated: '仅译文',
      modeTranslatedDesc: '只显示翻译后的中文',
      noTitlesToTranslate: '当前列表没有需要翻译的标题',
      stopBatchTranslateTitles: '停止标题翻译',
      translateButton: '翻译文章',
      translateButtonWithMode: '翻译：{mode}',
    },
    videoPlayer: {
  ...
  setting: {
    ...
    content: {
      ...
      enableTranslationDesc: '启用阅读页翻译按钮和翻译相关设置',
      ...
      targetLanguage: '目标语言',
      targetLanguageDesc: '将文章正文和标题翻译成此语言',
      translateTitles: '翻译文章标题',
      translateTitlesDesc: '仅在当前文章切换到翻译模式时翻译标题并缓存结果',
