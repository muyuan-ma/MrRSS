...
type Defaults struct {
	AgentDigestEnabled bool             `json:"agent_digest_enabled"`
	AgentDigestMaxArticles int          `json:"agent_digest_max_articles"`
	AgentDigestTime string              `json:"agent_digest_time"`
	AgentMemoryDislikes string          `json:"agent_memory_dislikes"`
	AgentMemoryInterests string         `json:"agent_memory_interests"`
	AgentMemoryNotes string             `json:"agent_memory_notes"`
	...
	TranslateTitlesEnabled bool         `json:"translate_titles_enabled"`
...
func GetString(key string) string {
	switch key {
	case "agent_digest_enabled":
		return strconv.FormatBool(defaults.AgentDigestEnabled)
	case "agent_digest_max_articles":
		return strconv.Itoa(defaults.AgentDigestMaxArticles)
	case "agent_digest_time":
		return defaults.AgentDigestTime
	case "agent_memory_dislikes":
		return defaults.AgentMemoryDislikes
	case "agent_memory_interests":
		return defaults.AgentMemoryInterests
	case "agent_memory_notes":
		return defaults.AgentMemoryNotes
	case "ai_api_key":
	...
	case "translate_titles_enabled":
		return strconv.FormatBool(defaults.TranslateTitlesEnabled)
